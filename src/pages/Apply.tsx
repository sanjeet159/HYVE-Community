...
const StepStory = ({ form, set, errors }: StepProps) => {
  ...
  const fetchSuggestions = async () => {
    ...
    const city = form.city || "my city";
    const exp = form.experience;
    const suggestionsMap: Record<string, string[]> = {
      "UI/UX": [
        `I have been designing interfaces for ${exp} years in ${city} and I am looking for a community where designers talk about real client work. HYVE feels like the right place to grow alongside people who actually ship products.`,
        `Most design communities are either too beginner-focused or too corporate. I want to connect with freelance designers who understand the hustle of finding good clients and delivering great work. HYVE is exactly what I have been looking for.`,
        `I am a UI/UX designer based in ${city}. I want to be in a space where I can find collaborators, get honest feedback, and maybe refer clients when I am at capacity. HYVE seems like that community.`,
      ],
      "Development": [
        `I have been freelancing as a developer in ${city} for ${exp} years and the hardest part is finding good clients and trustworthy collaborators. I want to join HYVE to build real relationships with people who take their craft seriously.`,
        `As a developer I often work alone and miss the energy of a team. HYVE feels like a place where I can connect with designers, marketers, and writers to build better products together and find clients who value quality work.`,
        `I have been building things for ${exp} years and I want to grow — not just technically but in terms of the clients I work with. HYVE is exactly the kind of environment I want to be part of.`,
      ],
      "Content Writing": [
        `I have been writing content for clients in ${city} for ${exp} years and I want to connect with a community that understands the value of good writing. HYVE feels like a place where my work will be respected.`,
        `Most freelance writing groups are full of people racing to the bottom on rates. I am looking for a curated space with professionals who value quality — HYVE is exactly that.`,
        `As a content writer with ${exp} years of experience, I want to collaborate with designers and developers to offer clients a complete package. HYVE seems like the perfect place to find those collaborators.`,
      ],
      "Digital Marketing": [
        `I have been doing digital marketing freelance work in ${city} for ${exp} years. I want to join HYVE to find collaborators I can trust and to be part of a community that shares real insights about getting good clients.`,
        `Marketing is most powerful as a team effort. I am looking for a community where I can connect with other freelancers, share leads, and build something bigger together. HYVE is that place.`,
        `After ${exp} years of freelancing in digital marketing, I know your network is everything. HYVE feels like the right community — people who are serious about their work and about helping each other grow.`,
      ],
      "Other": [
        `I have been freelancing in ${city} for ${exp} years and I am looking for a tight-knit community of people who take their craft seriously. HYVE's curated approach means I will be surrounded by professionals worth learning from.`,
        `Finding good collaborators as a freelancer is hard. I want to join HYVE because it seems like a space where people genuinely help each other — sharing clients, collaborating on projects, and giving honest feedback.`,
        `After ${exp} years of freelancing, I have learned that the right community makes all the difference. HYVE's focus on real work for real clients aligns perfectly with how I approach my own work.`,
      ],
    };
    const list = suggestionsMap[form.primary_skill] ?? suggestionsMap["Other"];
    setSuggestions(list);
    setLoadingAi(false);
  };
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="rounded-2xl border border-primary/30 bg-gradient-to-br from-primary/8 via-background to-background p-5">
        ...
        {aiError && <p className="mt-3 text-xs text-amber-700 bg-amber-50 rounded-lg px-3 py-2">{aiError}</p>}
        <AnimatePresence>
